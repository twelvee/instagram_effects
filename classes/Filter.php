...
class Filter {
	...
	public function __construct(&$image) {
		...
		$this->assetDirectory = '../placeholders/';
	}
	...
	public function bubbles() {
		...
		$dest = imagecreatefromjpeg($this->assetDirectory . "pt4.jpg");
	...
	public function colorise() {
		...
		$dest = imagecreatefromjpeg($this->assetDirectory . "pt5.jpg");
	...
	public function old2() {
		...
		$dest = imagecreatefromjpeg($this->assetDirectory . "pt1.jpg");
	...
	public function old3() {
		...
		$dest = imagecreatefromjpeg($this->assetDirectory . "pt3.jpg");
